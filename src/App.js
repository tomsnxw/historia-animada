    ...
    <div className="App">
      ...
      <section className="section" id="section1" ref={sectionRefs[0]}>
        <video controls={true} autoPlay loop>
          <source src={process.env.PUBLIC_URL + "/videos/1.mp4"} type="video/mp4" />
        </video>
      </section>

      <section className="section" id="section2" ref={sectionRefs[1]}>
        <video controls={true} autoPlay loop>
          <source src={process.env.PUBLIC_URL + "/videos/2.mp4"} type="video/mp4" />
        </video>
      </section>

      <section className="section" id="section3" ref={sectionRefs[2]}>
        <video controls={true} autoPlay loop>
          <source src={process.env.PUBLIC_URL + "/videos/3.mp4"} type="video/mp4" />
        </video>
      </section>

      <section className="section" id="section4" ref={sectionRefs[3]}>
        <video controls={true} autoPlay loop>
          <source src={process.env.PUBLIC_URL + "/videos/4.mp4"} type="video/mp4" />
        </video>
      </section>

      <section className="section" id="section5" ref={sectionRefs[4]}>
        <video controls={true} autoPlay loop>
          <source src={process.env.PUBLIC_URL + "/videos/5.mp4"} type="video/mp4" />
        </video>
      </section>
